...
|----------|----------|-------------|
| **😌 Mood Tracker** | ![Mood Tracker](./assets/mood_tracker.png) | Console-based app to log moods, view summaries, and export history to CSV. |
| **🎵 Music Player** | ![Music Player](./assets/music_player.png) | Tkinter + Pygame music player with basic controls. |
| **🎧 Modern Music Player Pro** | ![Modern Player](./assets/modern_music_player.png) | CustomTkinter-based upgraded version with progress bar and volume control. |
| **🎥 Screen Recorder** | ![Screen Recorder](./assets/screen_recorder.png) | Records your screen and saves it as a video file using PyAutoGUI + OpenCV. |
| **🕒 Digital Clock** | ![Digital Clock](./assets/digital_clock.png) | Minimalist Turtle graphics clock showing current time. |
